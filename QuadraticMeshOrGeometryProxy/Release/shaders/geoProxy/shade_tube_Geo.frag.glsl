...
void TwoSphereIntersection(in vec3 center1, in vec3 center2, in vec3 rayDir, out vec3 sNormal, out vec3 hitP, out float t, out bool discardFlag )
{
...
void main( void )
{
    ...
    CylinderIntersection(vertFragPos1, vertFragPos2, rayDir, normal_cylinder, hitP_cylinder, t_cylinder, discardFlagCylinder);                 
    TwoSphereIntersection(vertFragPos1, vertFragPos2, rayDir, normal_sphere, hitP_sphere, t_sphere, discardFlagSphere);

...
class ScoreMatrixDoubleLineDir : public ScoreMatrix
{
public:
    ...
    ScoreMatrixDoubleLineDir(void);

    // Construct the matrix with specific size
    // Actually allocate the memory --- deprecated
    ScoreMatrixDoubleLineDir(HelixGeometry *moduleSet, HelixGeometry *dataSet);

...
class ScoreMatrixSingleLineDir : public ScoreMatrix
{
...
public:
    ...
    ScoreMatrixSingleLineDir(void);

    ScoreMatrixSingleLineDir(HelixGeometry *moduleSet, HelixGeometry *dataSet);

    ~ScoreMatrixSingleLineDir(void);

    /*** Setters ***/
    // Set the module set
    void SetModuleSet( HelixGeometry *moduleSet ) { m_moduleSet = moduleSet; Reset(); }
    // Set the data set
    void SetDataSet( HelixGeometry *dataSet )     { m_dataSet = dataSet; Reset(); }
    // Set both module and data set
    void SetModuleAndDataSet(HelixGeometry *moduleSet, HelixGeometry *dataSet) { m_moduleSet = moduleSet; m_dataSet = dataSet; Reset(); }
...
private:
    ...
    // set and data set.
    HelixGeometry *m_moduleSet;
    HelixGeometry *m_dataSet;
...
private:    
    ...
    // Fill in the entry of the score matrix for Orient Single Line Direction
    double ComputeEntryOrientLine(int x, int y);

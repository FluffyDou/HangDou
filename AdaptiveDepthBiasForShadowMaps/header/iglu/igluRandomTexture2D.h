...
#ifndef IGLU_RANDOMTEXTURE2D_H
#define IGLU_RANDOMTEXTURE2D_H
...
class IGLURandomTexture2D : public IGLUTexture
{
public:
    IGLURandomTexture2D( unsigned int width, unsigned int height,                   // Texture width & height
	...
	typedef IGLURandomTexture2D *Ptr;
